...
local tl_ops_api_rule, _ = tl_ops_utils_func:get_req_post_args_by_name(tl_ops_constant_api.cache_key.api_rule, 1);
...
local tl_ops_api_list, _ = tl_ops_utils_func:get_req_post_args_by_name(tl_ops_constant_api.cache_key.api_list, 1);
...
local cache_list, _ = cache:set(tl_ops_constant_api.cache_key.api_list, cjson.encode(tl_ops_api_list));
...
local cache_rule, _ = cache:set(tl_ops_constant_api.cache_key.api_rule, tl_ops_api_rule);
...
local res_data = {}
res_data[tl_ops_constant_api.cache_key.api_rule] = tl_ops_api_rule
res_data[tl_ops_constant_api.cache_key.api_list] = tl_ops_api_list
