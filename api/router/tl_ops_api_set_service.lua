...
local Router = function() 
    ...
    if not tl_ops_service_rule or tl_ops_service_rule == nil then
        tl_ops_utils_func:set_ngx_req_return_ok(tl_ops_rt.args_error ,"s args err1", _);
        return;
    end
    ...
    if not tl_ops_service_list or tl_ops_service_list == nil then
        tl_ops_utils_func:set_ngx_req_return_ok(tl_ops_rt.args_error ,"s args err2", _);
        return;
    end
    ...
    if has_new_service_name == nil then
        tl_ops_utils_func:set_ngx_req_return_ok(tl_ops_rt.args_error ,"s args err3", _);
        return;
    end
    ...
    if has_new_service_name == true and new_service_name == nil then
        tl_ops_utils_func:set_ngx_req_return_ok(tl_ops_rt.args_error ,"s args err4", _);
        return;
    end
