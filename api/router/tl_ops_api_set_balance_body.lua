...
local Router = function() 
    ...
    if not list or list == nil then
        tl_ops_utils_func:set_ngx_req_return_ok(tl_ops_rt.args_error ,"bb args err5", _);
        return;
    end
    ...
    if not list_single or list_single == nil then
        tl_ops_utils_func:set_ngx_req_return_ok(tl_ops_rt.args_error ,"bb args err6", _);
        return;
    end
