...
local Handler = function()
    ...
    if service_empty then
        ...
        if not res then
            return tl_ops_rt.error, "set service_empty err ", _
        end
    ...
    if mode_empty then
        ...
        if not res then
            return tl_ops_rt.error, "set mode_empty err ", _
        end
    ...
    if host_empty then
        ...
        if not res then
            return tl_ops_rt.error, "set host_empty err ", _
        end
    ...
    if host_pass then
        ...
        if not res then
            return tl_ops_rt.error, "set host_pass err ", _
        end
    ...
    if token_limit then
        ...
        if not res then
            return tl_ops_rt.error, "set token_limit err ", _
        end
    ...
    if leak_limit then
        ...
        if not res then
            return tl_ops_rt.error, "set leak_limit err ", _
        end
    ...
    if offline then
        ...
        if not res then
            return tl_ops_rt.error, "set offline err ", _
        end
