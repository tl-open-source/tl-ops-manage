...
local tl_ops_health_list, _ = tl_ops_utils_func:get_req_post_args_by_name(tl_ops_constant_health.cache_key.options_config, 1);
...
local cache_list, _ = cache:set(tl_ops_constant_health.cache_key.options_config, cjson.encode(tl_ops_health_list));
...
local res_data = {}
res_data[tl_ops_constant_health.cache_key.options_config] = tl_ops_health_list
