...
function _M:tl_ops_process_init_worker()
    ...
    tlog:dbg("log_analyze plugin tl_ops_process_init_worker")
...
function _M:tl_ops_process_init_rewrite()
    ...
    tlog:dbg("log_analyze plugin tl_ops_process_init_rewrite")
...
function _M:tl_ops_process_init_access()
    ...
    tlog:dbg("log_analyze plugin tl_ops_process_init_access")
...
function _M:tl_ops_process_init_content()
    ...
    tlog:dbg("log_analyze plugin tl_ops_process_init_content")
...
function _M:tl_ops_process_init_header()
    ...
    tlog:dbg("log_analyze plugin tl_ops_process_init_header")
...
function _M:tl_ops_process_init_body()
    ...
    tlog:dbg("log_analyze plugin tl_ops_process_init_body")
...
function _M:tl_ops_process_init_log()
    ...
    tlog:dbg("log_analyze plugin tl_ops_process_init_log")
