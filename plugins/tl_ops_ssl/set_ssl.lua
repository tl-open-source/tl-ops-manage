...
local Router = function() 
    ...
    local list, _ = tl_ops_utils_func:get_req_post_args_by_name(tl_ops_constant_ssl.cache_key.list, 1);
    ...
    local cache_list, _ = cache:set(tl_ops_constant_ssl.cache_key.list, cjson.encode(list));
    ...
    local res_data = {}
    res_data[tl_ops_constant_ssl.cache_key.list] = list
