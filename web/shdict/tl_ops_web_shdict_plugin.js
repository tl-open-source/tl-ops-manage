...
const tl_ops_web_shdict_render = function () {
    table.render(tl_ajax_data({
        elem: '#'+_table_id_name,
        url: '/tlops/state/shdict/get?type=plugin',
        ...
        parseData: function(res){
            ...
            $('#tl-ops-web-shdict-plugin-all')[0].innerHTML = `
            ...
            $('#tl-ops-web-shdict-plugin-used')[0].innerHTML = `
                <b style='color:red;font-size:16px;cursor: pointer;' class="layui-badge layui-bg-red">
                    ${capacity - free_space}
                </b>
...
const tl_ops_web_shdict_view = function (evtdata) {
    let index = layer.open({
        ...
        ,content: 'tl_ops_web_shdict_view.html?type=plugin&key='+evtdata.key
        ,maxmin: true
        ,minStack:false
        ,area: ['700px', '600px']
