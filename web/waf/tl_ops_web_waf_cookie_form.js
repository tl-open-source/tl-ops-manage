...
const _form_select_service_id_name = "tl-ops-web-waf-cookie-form-service";

const _form_select_node_view_id_name = "tl-ops-web-waf-cookie-form-service-node-view";
const _form_select_node_tlp_id_name = "tl-ops-web-waf-cookie-form-service-node-tpl";
const _form_select_node_service_id_name = "tl-ops-web-waf-cookie-form-service-node";
let service_data = {};
...
const tl_ops_web_waf_cookie_form_main = async function (){
    ...
    form.on('select', function(data){
        if(data.elem.id === _form_select_service_id_name){//service
            tl_ops_web_waf_cookie_form_select_service_node_render(data.value)
        }
    }); 
    ...
    if(service_args || node_args || white_args){
        ...
        //渲染完tpl，进行编辑赋值
        tl_ops_web_waf_cookie_form_select_service_node_render( service_args )
        form.val(_form_id_name, Object.assign(form.val(_form_id_name), {
            node : node_args
        }))
    }
...
const tl_ops_web_waf_cookie_form_select_service_node_render = function( service_name ){
