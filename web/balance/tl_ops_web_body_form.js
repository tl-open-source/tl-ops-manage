const _form_btn_id_name = "tl-ops-web-body-form-submit";
const _form_id_name = "tl-ops-web-body-form";

const _form_select_view_id_name = "tl-ops-web-body-form-service-view";
const _form_select_tlp_id_name = "tl-ops-web-body-form-service-tpl";
const _form_select_service_id_name = "tl-ops-web-body-form-service";

const _form_select_node_view_id_name = "tl-ops-web-body-form-service-node-view";
const _form_select_node_tlp_id_name = "tl-ops-web-body-form-service-node-tpl";
const _form_select_node_service_id_name = "tl-ops-web-body-form-service-node";
let service_data = {};

const tl_ops_web_body_form_main = async function (){
    window.$ = layui.$;
    ...
    form.on('select', function(data){
        if(data.elem.id === _form_select_service_id_name){//service
            tl_ops_web_body_form_select_service_node_render(data.value)
        }
    }); 
    ...
    //渲染select
    tl_ops_web_body_form_select_service_render();
    ...
    if(service_args || node_args){
        ...
        //渲染完tpl，进行编辑赋值
        tl_ops_web_body_form_select_service_node_render( service_args )
        form.val(_form_id_name, Object.assign(form.val(_form_id_name), {
            node : node_args
        }))
    }
...
const tl_ops_web_body_form_select_service_render = function(  ){
